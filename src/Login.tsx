        ...
        <div className="flex justify-center items-center min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${background})` }}>
            <div className="flex flex-col md:flex-row w-full bg-opacity-50 bg-black">
                ...
                <div className='div-right flex justify-center items-center p-6 md:w-1/2 w-full md:min-h-screen h-auto'>
                    <form className="max-w-sm mx-auto p-6 border rounded-2xl 
                    border-stone-800 w-full bg-black bg-opacity-75" style={{ maxWidth: "32rem", height: "24rem" }}>
                        <div className="mb-3">
                            ...
                            dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@gmail.com" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mật khẩu</label>
                            <input type="password" id="password" className="bg-gray-50 border 
